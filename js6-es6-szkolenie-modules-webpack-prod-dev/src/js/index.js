...
document.getElementById('from-js-file').innerText = allInformations.addingNumbers(4, 11);
...
h1demoTwo.innerHTML = '9 + 16 = ' + sumNumbersTwo; //To samo co wyżej, tylko "stary" sposób zapisu ---> ale wciąż działa (mój pomysł)  
