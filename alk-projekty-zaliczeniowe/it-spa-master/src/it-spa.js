...
$(".text-light").on({
    click: () => {
        if (
            ...
            allRoomsContent.allRoomsDisablesAndHovers(); //wszelkie hovery, wyłączenia przy wczytaniu strony (w Rooms)
            ...
            allTreatmentsContent.allstateTreatmentsInfo(); //informacje przy zmianie zakładki co dodano co nie (do hoverów i aktywnych, nieaktywnych przycisków)
